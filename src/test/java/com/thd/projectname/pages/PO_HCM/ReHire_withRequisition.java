...
public class ReHire_withRequisition extends BasePage {
    private static final Logger log = LogManager.getLogger(ReHire_withRequisition.class);
...
//public WebElement homecountryPreHire;
    ...
    @FindBy(xpath = "//label[text()='Type']//following::*[@data-automation-id='promptIcon']")
...
//    public WebElement deptEditProCompHire;
    ...
    public ReHire_withRequisition() throws IOException {
    }
...
//            workdaycommon.selectfromduplicates(Position);
     ...
     automation script of close job requisition on same day with current date of executuon */
                    elem.sendKeys(Constants.RECRUITSTARTDATEJOBREQREHIREEMP);
            ...
            if (driverWrapper.isElementPresent(targethiredateCreateJobReq)) {
                for (WebElement elem : driver.findElements(By.xpath("(//*[@data-automation-id='dateWidgetInputBox'])[2]"))) {
                    elem.sendKeys(Constants.TARGETHIREDATEJOBREQREHIREEMP);
                    elem.sendKeys(Keys.TAB);
                    elem.sendKeys(Keys.TAB);
                }
            }
            ...
            WebActionsUtil.explicitWait(driver,editjobdetailsCreateJobReq,"click");
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.PRIMARYLOCJOBREQREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.COSTCENTERJOBREQREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
...
//            WebActionsUtil.explicitWait(driver, deptEditProCompHire, "click");
            ...
            {
                log.info("Next button is not coming for re-hire");
            }
            workdaycommon.userWait(2000);
            WebActionsUtil.explicitWait(driver,btnsubmitCreateJobReq,"click");
...
//            }
    ...
    public void HirefromRequisition(String empname1) throws Exception
    {
//        empname1 = this.FNAMECREATEPREHIRE1 + " " + this.LNAMECREATEPREHIRE1;
        workdaycommon.setDriver(driverWrapper);
        workdaycommon.setExtentTest(test);
        String reqName = "Req3866 New WD Test analyst065125";
        workdaycommon.gotoWorkdayHomepage();
//        workdaycommon.startProxy(Constants.BP_Admin);
        workdaycommon.startProxy(Constants.Manager_7052);// Rehire through 7152 Manager
        StringBuilder cutReqName=new StringBuilder(reqName);
        cutReqName.delete(8,reqName.length());
        String CutReqID= cutReqName.toString();
        workdaycommon.userWait(2000);
//        workdaycommon.searchbySearchBox(reqName);
        workdaycommon.searchbySearchBox(CutReqID);
        workdaycommon.userWait(5000);
...
//        actionsCreateJobReq.click();
        ...
        insidesearchboxcommon.sendKeys(empname1,Keys.ENTER);
        workdaycommon.userWait(3000);
        okButton.click();
    }

    ///for RE-hire, following is not needed
/*
    public void TD_createPrehire(String Country) throws Exception {
        try {
            ...
            for (int i = 0; i <= FName.size(); i++) {
                ...
                typeemailCreatePreHireSearchbox.sendKeys(Constants.EMAILTYPEECREATEPREHIRE, Keys.ENTER);
                workdaycommon.userWait(2000);
...
//                PageActionsUtil.clickButton(driverWrapper, doneButtonCreatePreHire);
    ...
    public void TD_Hire_HireAssociate(String JobProfile, String ReHireDate) throws Exception {
        ...
        try {
            ...
            if (driverWrapper.isElementPresent(hiredateHireEmployee)) {
                ...
                for (WebElement elem : driver.findElements(By.xpath("//*[@data-automation-id='dateWidgetInputBox']"))) {
                    elem.sendKeys(ReHireDate);
                    elem.sendKeys(Keys.TAB);//do not comment this, cz hire reason depends on this
                }
            }
            //insidesearchboxcommon.sendKeys(Reason, Keys.ENTER);
            insidesearchboxcommon.sendKeys(Constants.REASONREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
            WebElement clickreason = driver.findElement(By.xpath("//*[@data-automation-id='promptOption' and contains(text(),'"+Constants.REASONREHIREEMP+"')]"));
            ...
            workdaycommon.scroll();
            test.pass("Re-Hire Created Successfully");
        } catch (Exception e) {
            log.error("Exception/Issue occurred:" + e.getMessage());
    ...
    public void TD_Hire_OrganizationAssignments() throws Exception {
        ...
        try {
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.COMPANYHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
            //Cost center
            ...
            clickToEnterInSearchBox.click();
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.COSTCENTERHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
            //Business Unit
            ...
            clickToEnterInSearchBox.click();
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.BUSINESSUNITHIREEMP, Keys.ENTER);
            */workdaycommon.userWait(3000);
...
//            addEditIDProCompHire.sendKeys(SSNNumber, Keys.ENTER);
    ...
    public void TD_Hire_EditID_DiffCountry(String Country) throws Exception {
...
//            int value = random.nextInt(10000);
            ...
            ///for RE-hire, following is not needed
            WebActionsUtil.explicitWait(driver,addrowmailbox,"click");
            addrowmailbox.click();
            log.info("Entering Government ID details......." + Country);
            log.info("Entering Government ID details......." + Constants.GOVIDHIREEMP);
            log.info("Entering Government ID details......."+Constants.SINHIREEMP+SIN);
...
//            addEditIDProCompHire.sendKeys(SSNNumber, Keys.ENTER);
    ...
    public void TD_Hire_ProposeCompensation(String empname, String Country) throws Exception {
...
//            String empname = this.FNAMECREATEPREHIRE1 + " " + this.LNAMECREATEPREHIRE1;
            ...
            workdaycommon.scrolltoElement(submitProCompHire);
            workdaycommon.userWait(1000);
            submitProCompHire.click();
            workdaycommon.userWait(2000);
...
*/
    ...
    public void TD_Onboarding(String empname1, String Country,String JobProfile) throws Exception {
//        empname1 = this.FNAMECREATEPREHIRE1 + " " + this.LNAMECREATEPREHIRE1;
        try {
            workdaycommon.setDriver(driverWrapper);
            workdaycommon.setExtentTest(test);
            ...
            //uncomment when doing Hire from Kelly snow proxy
            ...
            try {
                ...
                if (workdaycommon.labelawaitingaction.isDisplayed()) {
                    ...
                    for (int i = 1; i <= count; i++) {
                        ...
                        //commenting the below proxy to Mngr bcz its already in Mngr proxy
                     /*   Threedots.click();
                        workdaycommon.scrolltoElement(securityProfile);
                        workdaycommon.mousemove(securityProfile,startProxyFromAssociateName);
                        workdaycommon.userWait(1000);
...
*/
            ...
            workdaycommon.scroll();
            //WebActionsUtil.explicitWait(driver,detailsTabOnboarding,"click");
...
//            WebElement PaymentElectionContact = driver.findElement(By.xpath("//div[@data-automation-id='inbox_row_title' and contains(text(),'Payment Election Enrollment Event')]"));
            ...
            workdaycommon.userWait(2000);
            WebActionsUtil.explicitWait(driver,PaymentElectionContact,"click");
            PaymentElectionContact.click();
            log.info("Clicked on PaymentElectionContact.....");

            // Following is not required for a re-hire
           /* workdaycommon.userWait(4000);
...
//            WebElement inboxfederal = driver.findElement(By.xpath("//div[@data-automation-id='inbox_row_title' and contains(text(),'Federal Tax Election For Onboarding')]"));
    ...
    public void changeEmergencyContact(String FNemergencyConctOnBoard, String LNemergencyConctOnBoard, String RelationShpOnB, String MailIdONB, String MobileOnbard) throws Exception {
        ...
        try {
            ...
            // For re-hire following is not required, uncomment only when needed
    ...
    public void TD_Hire_ProposeCompensation_DiffCountry(String empname, String Country) throws Exception {
...
//            String empname = this.FNAMECREATEPREHIRE1 + " " + this.LNAMECREATEPREHIRE1;
            ...
            ///for RE-hire, following is needed only whn one Country to diff country
            workdaycommon.userWait(2000);
            WebActionsUtil.explicitWait(driver,workdaycommon.inboxWD,"click");
            workdaycommon.inboxWD.click();
            workdaycommon.userWait(2000);
            ...
            try {
                ...
                log.info("Running in Catch Block.........");
                workdaycommon.gotoWorkdayHomepage();
                AwaitingAction_ProposeCompHire_DiffCountry(empname, Country);
            }
        } catch (Exception e) {
            workdaycommon.takescreenshotUI("Exception", this.FNAMECREATEPREHIRE1);
            log.error("Exception/Issue occurred:" + e.getMessage());
    ...
    public void AwaitingAction_ProposeCompHire_DiffCountry(String empname1, String Country) throws Exception {
        workdaycommon.setDriver(driverWrapper);
        workdaycommon.setExtentTest(test);
        workdaycommon.searchbySearchBox(empname1);
        workdaycommon.userWait(1000);
