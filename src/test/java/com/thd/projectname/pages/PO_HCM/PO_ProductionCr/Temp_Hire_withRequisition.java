...
public class Temp_Hire_withRequisition extends BasePage {
...
//    public WebElement deptEditProCompHire;
    ...
    public Temp_Hire_withRequisition() throws IOException {
    }
...
//                    workdaycommon.scrolltoElement(inboxbtndoneCreateJobReq); //uncomment when awaiting action is coming
...
//      // below is to get associate ID
        ...
        test.pass("Hire Process Completed Successfully - Employee name :" + empname1 + " , " + "Country: " + Country);
        log.info("Hire Process Completed Successfully - Employee name :" + empname1 + " , " + "Country: " + Country);
        //
