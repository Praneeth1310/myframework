...
public class Temp_Hire_withRequisition_6Step extends BasePage {
    private static final Logger log = LogManager.getLogger(Temp_Hire_withRequisition.class);
...
//     @FindBy(xpath = "(//label[text()='Race/Ethnicity']//following::div[@data-automation-id='icon'])[4]")
    ...
    public Temp_Hire_withRequisition_6Step() throws IOException {
    }
...
//            WebElement Threedots = driver.findElement(By.xpath("(//div[text()='Awaiting Action'])[1]//following::img[1]//following::img[2]"));
            ...
            //uncomment when awaiting action is coming, and uncomment StartProxy from hire from requisition() also 2 lines in below if()
//            workdaycommon.scrolltoElement(awaitingaprovernameCreateJobReq);
//            //Getting Approver name
//            StringBuilder aprovername = new StringBuilder(awaitingaprovernameCreateJobReq.getText());
//            log.info("Before replacing the Aprover name :" + aprovername);
...
//                    workdaycommon.scrolltoElement(inboxbtndoneCreateJobReq); //uncomment when awaiting action comes
...
//            }
    ...
    public void HirefromRequisition() throws Exception
    {
        ...
        workdaycommon.gotoWorkdayHomepage();
//        workdaycommon.startProxy(Constants.BP_Admin); //uncomment when awaiting action is coming in Create Job requisition
...
//        actionsCreateJobReq.click();
    ...
    //public void CreatePrehire(String Country,String EmailType,String HomeAddressline1,String HomeAddressline2,String HomeCity,String HomeProvince,String HomeState,String HomePostalcode,String HomeType) throws Exception {
        try {
            workdaycommon.setDriver(driverWrapper);
            log.entry();
...
//                typeemailCreatePreHireSearchbox.sendKeys(EmailType);
                workdaycommon.userWait(2000);
...
//                homeaddressline1PreHire.sendKeys(HomeAddressline1, Keys.ENTER);
//                workdaycommon.userWait(2000);
//                homeaddressline2PreHire.sendKeys(HomeAddressline2, Keys.ENTER);
//                workdaycommon.userWait(2000);
//                homecityPreHire.sendKeys(HomeCity, Keys.ENTER);
       ...
       //             insidesearchboxcommon.sendKeys(HomeProvince, Keys.ENTER);
                }
                else
                {
                    log.info("US data");
...
//                    insidesearchboxcommon.sendKeys(HomeState, Keys.ENTER);
//                }
//                workdaycommon.userWait(2000);
//                homepostalcodePreHire.sendKeys(HomePostalcode, Keys.ENTER);

                workdaycommon.userWait(2000);
                hometypePreHire.click();
                workdaycommon.userWait(1000);
                insidesearchboxcommon.sendKeys(Constants.HOMETYPEPREHIRE, Keys.ENTER);
                //insidesearchboxcommon.sendKeys(HomeType, Keys.ENTER);
...
//            log.info("Entering Government ID details......." + GovID);
  //          log.info("Entering Government ID details.......0541"+SIN);
       ...
       //     addEditIDProCompHire.sendKeys("0541"+SIN, Keys.ENTER);
            workdaycommon.userWait(3000);
...
*/
    ...
    public void Onboarding(String Country,String FNameEmerCon, String InstituteNum ,String BranchID ,String AccNum, String BankName) throws Exception {
        try {
            workdaycommon.setDriver(driverWrapper);
            workdaycommon.setExtentTest(test);
...
//                    workdaycommon.startProxy(proxyperson.toString());
                    ...
                    if (Country.equalsIgnoreCase("Canada")) {
                        ...
                        paymentElection(InstituteNum,BranchID,AccNum,BankName);
                        changePhoto();
                        provinceHolding();
                        completeFederal(Country);
                        changeEmergencyContact(FNameEmerCon);
                    } else {
    ...
    public void veteranStatus() throws Exception {
        try {
            ...
            workdaycommon.userWait(3000);
            insidesearchboxcommon.sendKeys(Constants.USAVETERENONB, Keys.ENTER);
            workdaycommon.userWait(2000);
            submitOnboarding.click();
            workdaycommon.userWait(4000);
        } catch (Exception e) {
...
//            workdaycommon.userWait(3000);
    ...
    public void paymentElection(String InstituteNum ,String BranchID ,String AccNum,String BankName) throws Exception {
        try {
...
//--------The fllowing code is changed/commented as it was
            ...
            institutionNbrOnboarding.sendKeys(InstituteNum, Keys.ENTER);
            workdaycommon.userWait(2000);
            workdaycommon.scrolltoElement(branchIDOnboarding);
            branchIDOnboarding.sendKeys(BranchID, Keys.ENTER);
            workdaycommon.userWait(2000);
//--------------------------------------------------------------
...
//            log.info("Clicked on PaymentElectionContact.....");
            ...
            actNbrOnboarding.sendKeys(AccNum, Keys.ENTER);
            workdaycommon.userWait(2000);
            log.info("Clicked on PaymentElectionContact.....");
    ...
    public void changeEmergencyContact( String FNameEmerCon) throws Exception {
        ...
        try {
            ...
            FNameCreatePreHire.sendKeys(FNameEmerCon, Keys.ENTER);
            workdaycommon.userWait(2000);
