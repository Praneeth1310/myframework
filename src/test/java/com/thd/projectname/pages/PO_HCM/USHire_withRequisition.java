...
public class USHire_withRequisition extends BasePage {
    private static final Logger log = LogManager.getLogger(USHire_withRequisition.class);
...
// Job Location----------------------------------------
    ...
    public USHire_withRequisition() throws IOException {
    }
...
*/
    ...
    public void TD_Onboarding(String Country, String WageTheftPrevention) throws Exception {
        try {
            workdaycommon.setDriver(driverWrapper);
            workdaycommon.setExtentTest(test);
