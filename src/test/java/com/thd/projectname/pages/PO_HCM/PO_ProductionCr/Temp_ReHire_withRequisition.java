...
public class Temp_ReHire_withRequisition extends BasePage {
    private static final Logger log = LogManager.getLogger(Temp_ReHire_withRequisition.class);
...
//    public WebElement deptEditProCompHire;
    ...
    public Temp_ReHire_withRequisition() throws IOException {
    }
...
//            workdaycommon.selectfromduplicates(Position);
     ...
     automation script of close job requisition on same day with current date of executuon */
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.COMPANYJOBREQREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
...
//            WebActionsUtil.explicitWait(driver, deptEditProCompHire, "click");
            ...
            workdaycommon.userWait(2000);
            compValProCompHire.sendKeys(Constants.DEPARTMENTREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(3000);
            btnnxtCreateJobReq.click();
            try {
                workdaycommon.userWait(1000);
...
//        workdaycommon.startProxy(Constants.BP_Admin);
        workdaycommon.startProxy(Constants.Manager_7052);// Rehire through store Manager
    ...
    public void TD_Hire_OrganizationAssignments() throws Exception {
        ...
        try {
            ...
            */workdaycommon.userWait(3000);
            ...
            deptValEditProCompHire.click();
            workdaycommon.userWait(2000);
            insidesearchboxcommon.sendKeys(Constants.DEPARTMENTREHIREEMP, Keys.ENTER);
            workdaycommon.userWait(3000);
...
//            String empname = this.FNAMECREATEPREHIRE1 + " " + this.LNAMECREATEPREHIRE1;
    ...
    public void AwaitingAction_ProposeCompHire(String empname1, String Country) throws Exception {
        ...
        test.pass("Rehire Process Completed Successfully - Employee name :" + empname1 + " , " + "Country: " + Country);
        log.info("Rehire Process Completed Successfully - Employee name :" + empname1 + " , " + "Country: " + Country);
        //
