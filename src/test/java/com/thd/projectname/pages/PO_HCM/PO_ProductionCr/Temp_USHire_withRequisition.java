...
public class Temp_USHire_withRequisition extends BasePage {
    private static final Logger log = LogManager.getLogger(Temp_USHire_withRequisition.class);
...
//public WebElement homecountryPreHire;
    ...
    public WebElement usatypeemailCreatePreHire;
...
// Job Location----------------------------------------
    ...
    public Temp_USHire_withRequisition() throws IOException {
    }
...
//******************************BP Specific functions**********************************************
    ...
    public void CreateJobRequisition(String SORG, String JobProfile) {
        try {
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(SORG, Keys.ENTER);
...
//            workdaycommon.selectfromduplicates(Position);
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USAREASONJOBREQHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
     ...
     automation script of close job requisition on same day with current date of executuon */
                    elem.sendKeys(Constants.USARECRUITSTARTDATEJOBREQHIREEMP);
            ...
            if (driverWrapper.isElementPresent(targethiredateCreateJobReq)) {
                for (WebElement elem : driver.findElements(By.xpath("(//*[@data-automation-id='dateWidgetInputBox'])[2]"))) {
                    elem.sendKeys(Constants.USATARGETHIREDATEJOBREQHIREEMP);
                    elem.sendKeys(Keys.TAB);
                    elem.sendKeys(Keys.TAB);
                }
            }
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USATIMETYPEJOBREQHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);

            workdaycommon.scrolltoElement(primaryLocationCreateJobReq);
            primaryLocationCreateJobReq.click();
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USAPRIMARYLOCJOBREQHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
...
//            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USACOMPANYJOBREQHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USACOSTCENTERJOBREQHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
...
//        reqName=Reqname.toString();
//        log.info("the Req name :" + reqName);
//        test.pass("Create job requisition completed and the requisition name is: "+reqName);
    ...
    public void TD_createPrehire(String Country) throws Exception {
        try {
            ...
            for (int i = 0; i <= FName.size(); i++) {
                ...
                workdaycommon.userWait(2000);
                workdaycommon.scrolltoElement(hometypePreHire);
                workdaycommon.userWait(1000);
...
//                PageActionsUtil.clickButton(driverWrapper, doneButtonCreatePreHire);
    ...
    public void TD_Hire_HireAssociate(String JobProfile, String HireDate) throws Exception {
...
//                    elem.sendKeys(Keys.TAB);
            ...
            insidesearchboxcommon.sendKeys(Constants.USAREASONHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
            WebElement clickreason = driver.findElement(By.xpath("//*[@data-automation-id='promptOption' and contains(text(),'" + Constants.USAREASONHIREEMP + "')]"));
    ...
    public void TD_Hire_OrganizationAssignments() throws Exception {
        ...
        try {
            ...
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USACOMPANYHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
            //Cost center
            ...
            clickToEnterInSearchBox.click();
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USACOSTCENTERHIREEMP, Keys.ENTER);
            workdaycommon.userWait(1000);
            ...
            clickToEnterInSearchBox.click();
            workdaycommon.userWait(1000);
            insidesearchboxcommon.sendKeys(Constants.USABUSINESSUNITHIREEMP, Keys.ENTER);
            workdaycommon.userWait(3000);
    ...
    public void TD_Hire_EditID(String Country) throws Exception {
...
//            int value = random.nextInt(10000);
            ...
            log.info("Entering Government ID details......." + Constants.USAGOVIDHIREEMP);
            log.info("Entering Government ID details......." + Constants.USASSNHIREEMP + SIN);
            ...
            workdaycommon.userWait(2000);
            nationalValIDProCompHire.sendKeys(Constants.USAGOVIDHIREEMP, Keys.TAB);
            workdaycommon.userWait(2000);
            addEditIDProCompHire.sendKeys(Constants.USASSNHIREEMP + SIN, Keys.ENTER);
//            addEditIDProCompHire.sendKeys(SSNNumber, Keys.ENTER);
    ...
    public void TD_Hire_ChangePersonalInfo(String Country) throws Exception {
        try {
    ...
    public void TD_Hire_ProposeCompensation(String Country) throws Exception {
        ...
        try {
            ...
            amountProCompHire.sendKeys(Keys.BACK_SPACE);
            amountProCompHire.sendKeys(Keys.BACK_SPACE);
            amountProCompHire.sendKeys(Constants.USAAMOUNTHIREEMP, Keys.ENTER);
            workdaycommon.userWait(2000);
            submitProCompHire.click();
            workdaycommon.userWait(2000);
...
*/
    ...
    public void sendemployee(String empname) {
        ...
        workdaycommon.setrandomnumber(value);
            ...
            public void pickassociateId(String empname1) throws Exception {
                workdaycommon.gotoWorkdayHomepage();
                workdaycommon.startProxy(empname1);
                workdaycommon.userWait(2000);
        workdaycommon.gotoWorkdayHomepage();
        ...
        test.info("Employee hired successfully, Employee Id:" + associate_ID);
    }
...
//                        WebElement inboxTextOnboarding = driver.findElement(By.xpath("//div[@data-automation-id='inbox_row_title' and contains(text(),'Hire: " + empname1 + "')]"));
                        WebElement inboxTextOnboarding = driver.findElement(By.xpath("//div[@data-automation-id='inbox_row_title' and contains(text(),'Visual Survey: Personal Information Change: "+empname1+"')]"));
...
//                    changeEmergencyContact(Constants.USAFNEMERGENCYCONTACTONB, Constants.USALNEMERGENCYCONTACTONB, Constants.USARELATIONSHPONB, Constants.USAMAILIDONB, Constants.USAMOBILEONB);
//                } else {
...
//                    workdaycommon.userWait(2000);
//
//                    if (Country.equalsIgnoreCase(Constants.USACOUNTRYCANADAHIRE)) {
//                        log.info("Mail Approval for Canada Region.....");
//                        PersonalInformation(Country);
//                        paymentElection();
//                        changePhoto();
...
//            }
            ...
            allOfWorkdayProCompHire.click();
            workdaycommon.userWait(3000);
            WebElement namelinkk = driver.findElement(By.xpath("(//*[text()='" + empname1 + "']//following::*[text()='Associate'])//preceding::*[@data-automation-id='promptOption' and contains(text(),'" + empname1 + "')][1]"));
            namelinkk.click();
            workdaycommon.userWait(2000);
            workdaycommon.clickAction.click();
            workdaycommon.userWait(1000);
...
//        sendemployee(associate_ID);
    ...
    public void AwaitingAction_Onboarding(String empname1, String Country) throws Exception {
        ...
        allOfWorkdayProCompHire.click();
        workdaycommon.userWait(9000);
        WebElement Employeenamee = driver.findElement(By.xpath("(//*[text()='" + empname1 + "']//following::*[text()='Associate'])//preceding::*[@data-automation-id='promptOption' and contains(text(),'" + empname1 + "')][1]"));
        workdaycommon.userWait(3000);
    ...
    public void PersonalInformation(String Country) throws Exception {
        try {
            ...
            if (Country.equalsIgnoreCase("Canada")) {
                ...
                insidesearchboxcommon.sendKeys(Constants.USCANADARACEONB, Keys.ENTER);
                workdaycommon.userWait(3000);
            } else {
                log.info("US Region...");
...
//            workdaycommon.userWait(5000);
    ...
    public void changeEmergencyContact(String FNemergencyConctOnBoard, String LNemergencyConctOnBoard, String RelationShpOnB, String MailIdONB, String MobileOnbard) throws Exception {
        ...
        try {
            ...
            FNameCreatePreHire.sendKeys(Constants.USAFNEMERGENCYCONTACTONB, Keys.ENTER);
            workdaycommon.userWait(2000);
