...
public class Temp_USHire_withRequisition_6Step extends BasePage {
    private static final Logger log = LogManager.getLogger(Temp_USHire_withRequisition_6Step.class);
...
//    @FindBy(xpath = "//div[@data-automation-id='promptSearchButton']")
    ...
    public Temp_USHire_withRequisition_6Step() throws IOException {
    }
